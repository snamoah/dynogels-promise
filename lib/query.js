...
internals.isUsingGlobalIndex = query =>
  query.request.IndexName &&
  query.table.schema.globalIndexes[query.request.IndexName]

function Query (hashKey, table, serializer) {
...
Query.prototype.exec = function (callback) {
  ...
  return new Promise((resolve, reject) => {
    ...
    return utils.paginatedRequest(self, runQuery, promisifiedCallback)
  })
}
...
Query.prototype.buildKey = function () {
  ...
  return expressions.buildFilterExpression(
    key,
    '=',
    existingValueKeys,
    this.hashKey
