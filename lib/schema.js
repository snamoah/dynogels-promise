...
Schema.types.uuid = () =>
  Joi.string()
    .guid()
    .default(() => nodeUUID.v4(), 'uuid v4')

Schema.types.timeUUID = () =>
  Joi.string()
    .guid()
    .default(() => nodeUUID.v1(), 'uuid v1')
...
internals.invokeDefaultFunctions = data =>
